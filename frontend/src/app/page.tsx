      ...
      <div className={styles.front}>
        <div className={styles.title}>
          ...
          <div className={styles.recs}>
            <div>
              <h3>Valuator</h3>
              Use our AI for for free to get an estimate on your multifamily
              property&apos;s value.
            </div>
            <div>
              <h3>Connect</h3>
              Connect with us to gain invaluable insights from industry leaders
              and experts.
            </div>
          </div>
  ...
  <main className="flex flex-col justify-center h-[90%] static md:fixed w-screen overflow-hidden grid-rows-[1fr_repeat(3,auto)_1fr] z-[100] pt-[30px] pb-[320px] px-4 md:px-20 md:py-0">
    ...
    >
      ...
      <div className="w-1/2">
        ...
        <p className="text-[14px] leading-[20px] text-[#1a2b3b] font-normal">
          Connect with us to gain invaluable insights from industry
          leaders and experts.
        </p>
      </div>
    </motion.div>
    ...
    <div className="flex gap-[15px] mt-8 md:mt-0">
      ...
      >
        <Link
          href="https://tayloravakian.carrd.co/"
