                ...
                <div className="mt-12 max-w-lg mx-auto">
                    ...
                    >
                        ...
                        <div>
                            ...
                            <textarea required className="w-full mt-2 h-36 px-3 py-2 resize-none appearance-none bg-transparent outline-none border focus:border-[#407BBF] shadow-sm rounded-lg"></textarea>
                        </div>
						<div>
                        </div>
