export default () => {
  ...
  const team = [
      {
          avatar: "https://www.matthews.com/wp-content/uploads/2018/10/Taylor-Avakian-Use-1.jpg",
          name: "Taylor Avakain",
          title: "Associate Vice President of Multifamily",
          desc: "Taylor Avakian is a premier client advisor for the acquisition and disposition of multifamily assets nationwide. His primary focus is on advancing his client’s positions by observing market trends and capitalizing on opportunities. Taylor has worked on over 100 transactions, both as an advisor and a principal and sold over $175M in real estate. He is adept at managing the process from beginning to end, including due diligence, financing, marketing, and sales. Taylor’s extensive knowledge of the market and his ability to identify opportunities are what make him stand out from other agents. He has been recognized as one of his region’s top commercial real estate agents, serving clients from all over the United States. His clients include some of the most notable companies in the world, and he prides himself on providing them with exceptional service.",
